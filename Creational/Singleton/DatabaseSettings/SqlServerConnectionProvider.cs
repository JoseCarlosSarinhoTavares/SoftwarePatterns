...
namespace SoftwarePatterns.Creational.Singleton.DatabaseSettings
{
    /// <summary>
    ...
    public class SqlServerConnectionProvider
    {
        ...
        /// </summary>
        private static readonly Lazy<SqlServerConnectionProvider> instance =
            new(() => new SqlServerConnectionProvider());
        ...
        /// </summary>
        /// <returns>Instância única de <see cref="SqlServerConnectionProvider"/>.</returns>
        public static SqlServerConnectionProvider GetInstance() => instance.Value;
