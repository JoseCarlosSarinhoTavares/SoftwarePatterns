using Creational.AbstractFactory.Reports.Factories;
using SoftwarePatterns.Creational.AbstractFactory.Reports.Factories;
using SoftwarePatterns.Creational.AbstractFactory.Reports.Interfaces;

namespace SoftwarePatterns.Creational.AbstractFactory.Reports
{
    /// <summary>
