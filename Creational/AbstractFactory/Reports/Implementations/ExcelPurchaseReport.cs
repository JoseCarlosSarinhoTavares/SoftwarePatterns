...
namespace SoftwarePatterns.Creational.AbstractFactory.Reports.Implementations
{
    /// <summary>
    /// Implementação de <see cref="IPurchaseReport"/> que gera relatórios de compras em Excel.
    /// </summary>
    public class ExcelPurchaseReport : IPurchaseReport
    {
        /// <summary>
        ...
        public void Generate(string path, LocalDate startDate, LocalDate endDate)
        {
            try
            {
                ...
                // Header
                worksheet.Cells["A1"].Value = "Relatório de compras";
