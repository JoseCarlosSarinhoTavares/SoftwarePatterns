...
using SoftwarePatterns.Creational.AbstractFactory.Authentication.Factories;

namespace SoftwarePatterns.Creational.AbstractFactory.Authentication
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            new TokensDataAccess(SqlServerDB.GetConnection()).GetAll().ForEach(token => Console.WriteLine(token));
        }
    }
}