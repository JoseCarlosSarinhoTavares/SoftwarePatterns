...
namespace SoftwarePatterns.Creational.AbstractFactory.Authentication.Data
{
    /// <summary>
    /// DAO para manipulação de tokens no banco de dados.
    /// </summary>
    public class TokensDataAccess
    {
        private readonly SqlConnection _connection;

        public TokensDataAccess(SqlConnection connection)
        {
