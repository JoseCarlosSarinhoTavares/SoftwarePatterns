...
using SoftwarePatterns.Creational.FactoryMethod.DatabaseConnection.Factories;

namespace SoftwarePatterns.Creational.FactoryMethod.DatabaseConnection
{
    /// <summary>
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Obtém a conexão via factory
            var sqlServerConnection = ConnectionsFactory.GetConnection("sqlserver");
            ...
            IDatabaseConnection sqliteConnection = ConnectionsFactory.GetConnection("sqlite");
