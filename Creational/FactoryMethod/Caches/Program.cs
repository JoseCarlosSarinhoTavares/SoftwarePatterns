...
using SoftwarePatterns.Creational.FactoryMethod.Caches.Factories;
using SoftwarePatterns.Creational.FactoryMethod.Caches.Interfaces;

namespace SoftwarePatterns.Creational.FactoryMethod.Caches
{
    /// <summary>
    ...
    internal class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            SqlServerCacheStore.Initialize();
