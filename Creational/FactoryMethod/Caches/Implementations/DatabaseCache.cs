using SoftwarePatterns.Creational.FactoryMethod.Caches.Data;
using SoftwarePatterns.Creational.FactoryMethod.Caches.Interfaces;

namespace SoftwarePatterns.Creational.FactoryMethod.Caches.Implementations
{
    /// <summary>
    ...
    public class DatabaseCache : ICache
    {
        ...
        {
            return SqlServerCacheStore.GetCache(key);
        }
        ...
        {
            SqlServerCacheStore.PutCache(key, value?.ToString());
        }
        ...
        {
            SqlServerCacheStore.RemoveCache(key);
        }
        ...
        {
            return SqlServerCacheStore.GetAll();
        }
    }
}